...
export default async function Blog({
  ...
  return (
    <Row fillWidth>
      <Column flex={1} hide="m"/>
      <Row fillWidth horizontal="center">
        <Column as="section" fillWidth maxWidth="l" gap="l">
          <Schema
            as="blogPosting"
            baseURL={baseURL}
            path={`${blog.path}/${post.slug}`}
    ...
    <Column flex={1} maxWidth="xs" paddingLeft="40" fitHeight position="sticky" top="80" gap="16" hide="m">
      <Row
        gap="12"
        paddingLeft="2"
        vertical="center"
